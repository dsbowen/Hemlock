...
<p class="func-header">
    <i>class</i> hemlock.<b>Label</b>(<i>label=None, template='hemlock/label.html', **kwargs</i>) <a class="src-href" target="_blank" href="https://github.com/dsbowen/hemlock/blob/master/hemlock/qpolymorphs/label.py#L11">[source]</a>
</p>
